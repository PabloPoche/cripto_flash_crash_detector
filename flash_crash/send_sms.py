...
a usuarios registrados y con numeros verificados(+5493364672804) en la plataforma.
...
def send(cripto):
    ...
    message = client.messages.create(to="+5493364672804",   # My verified phone numbers(trial account).
